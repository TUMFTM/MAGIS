<?php
@define('CONST_BasePath', '{NOMINATIM_PATH}');
@define('CONST_InstallPath', '{NOMINATIM_PATH}/build');
...
@define('CONST_Database_DSN', 'pgsql://{NOMINATIM_DB_USER}:{NOMINATIM_DB_USER_PASSWORD}@{NOMINATIM_HOST}:{NOMINATIM_PSQL_PORT}/{NOMINATIM_DB_NAME}'); // <driver>://<username>:<password>@<host>:<port>/<database>
@define('CONST_Database_Web_User', '{NOMINATIM_DB_USER}');
...
@define('CONST_Pyosmium_Binary', '/nonexistent');
